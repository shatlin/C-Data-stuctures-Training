...
function sa_onclick(s_n,s_6){window.SA_Title=(typeof(SA_Title)==s_k||SA_Title==null)?"media_file":escape(SA_Title);sa_click=s_n;if(!(typeof(s_6)==s_k||s_6==null)){window.SA_Message=s_6;}if((navigator.appName.indexOf("Netscape")!=-1)){setTimeout("sl()",0);}else{s_l();}return(true);}

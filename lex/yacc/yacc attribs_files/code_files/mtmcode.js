...
var MTMCodeFrame = "code", MTMenuFrame = "menu", MTMTableWidth = "100%", MTMenuImageDirectory = "../menu/";
var MTMUseToolTips = true, MTMEmulateWE, MTMAlwaysLinkIfWE = true, MTMSubsGetPlus = "Submenu", MTMSubsAutoClose;
var MTMBackground = "", MTMBGColor = "#333333", MTMTextColor = "#ffffff", MTMLinkColor = "#ffffff", MTMTrackColor = "#ffff00", MTMAhoverColor = "#ffffff", MTMSubExpandColor = "#ffffff", MTMSubClosedColor = "#ffffff", MTMSubTextColor = "#ffffff";
var MTMenuText = "Contents", MTMRootIcon = "menu_new_root.gif", MTMRootColor = "#ffffff";
...
if (typeof Gray0 != "undefined") {
    MTMBGColor = "#000000";
    MTMRootColor = "#cccccc";
    MTMLinkColor = "#cccccc";
    MTMAhoverColor = "#ffffff";
} else {
    MTMBGColor = "#333333";
    MTMRootColor = "#ffffff";
    MTMLinkColor = "#ffffff";
